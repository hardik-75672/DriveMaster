...
import { signUpAsync, selectUser } from "../redux/Slice/authSlice";
...
const SignUp = () => {
  ...
  return (
    <>
      {user1 && <Navigate to="/home" replace={true}></Navigate>}
      <div className=" flex justify-center  item-middle h-screen">
        <div className="w-full  max-w-md p-4 items-center rounded-md shadow sm:p-8 bg-gray-50 text-gray-800">
